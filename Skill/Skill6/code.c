...
// Function to parse input string while handling escape sequences
...
void validate_and_print_tokens(
    char tokens[MAX_TOKENS][MAX_TOKEN_LEN],
    int count)
{
...
int main()
{
    ...
    const char *test_input_1 =
        "echo Hello\\ World \\$100 \\&\\| special\\nvalue";

    const char *test_input_2 =
        "ls -l /path/with\\ spaced\\ directory/file.txt";
